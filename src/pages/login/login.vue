<template lang="html">
  <div class="container">
      <div class="top_part">
          <div id="login_box" :style="activeName=='sign_up' ? 'padding-top:40px;' : ''">
                          ...
                          <div v-if="activeName=='sign_up'">
                              ...
                              <el-form-item prop="message_code">
                                  <el-input placeholder="短信验证码" v-model="sign.message_code">
                                      <el-button slot="append" style="width:120px" @click="getMessageCode('register')" :disabled="registe_timer_disabled">
